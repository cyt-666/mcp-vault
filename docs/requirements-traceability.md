...
| Migration from prior prerelease state | `pre_wp02.sql` upgrade test through migration 0011; focused 0009, 0010, and destructive 0011 memory-cutover checks | Automated; preserve fixture and migration checksums |
