...
and provider/budget recovery must resume incremental work. Compatible vectors
...
is retained and cached. Actual dispatches, including retries, reserve persistent
rolling per-Vault budgets before network I/O. No private bodies enter logs.
