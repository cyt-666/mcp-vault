...
const errorMessages: Record<string, string> = {
  ...
  memory_retrieval_not_ready: '跨语言检索回填尚未就绪，请先允许 AI 调用并绑定记忆整理模型。',
...
const jobErrorMessages: Record<string, string> = {
  ...
  memory_source_repair_vault_lookup_failed: '暂时无法读取待修复 Vault，将自动重试',
  memory_source_repair_core_unavailable: '暂时无法访问待修复 Vault 文件，将自动重试',
  memory_source_repair_progress_failed: '历史记忆来源修复进度无法保存，将自动重试',
  memory_source_repair_retryable: '历史记忆来源修复暂时失败，将自动重试',
  memory_source_repair_failed: '历史记忆来源修复失败，请检查服务日志',
  memory_source_reconcile_retryable: '记忆来源协调暂时失败，将自动重试',
  memory_source_reconcile_failed: '记忆来源协调失败，请检查服务日志',
  memory_source_audit_retryable: '记忆来源审计暂时失败，将自动重试',
  memory_source_audit_failed: '记忆来源审计失败，请检查服务日志',
  memory_source_audit_counts_unavailable: '暂时无法读取记忆来源总数，将自动重试',
  memory_source_audit_checkpoint_failed: '记忆来源审计游标无法保存，将自动重试',
  memory_source_audit_progress_failed: '记忆来源审计进度无法保存，将自动重试',
  memory_source_audit_stage1_count_failed: '暂时无法读取阶段一待整理数量，将自动重试',
  memory_source_audit_consolidation_admission_failed: '来源审计完成，但后续记忆整理任务暂时无法提交',
  ...
  memory_phase1_slug_invalid: '旧版本拒绝了格式不符的可选摘要短标识；升级后重试即可',
  memory_retrieval_not_ready: '尚未配置可用的记忆整理模型，无法生成跨语言检索信息',
  memory_retrieval_output_invalid: 'AI 返回的跨语言检索结果无法解析',
  memory_retrieval_item_count_invalid: 'AI 返回的跨语言检索条目数量不正确',
  memory_retrieval_index_invalid: 'AI 返回了不存在的记忆序号',
  memory_retrieval_index_duplicate: 'AI 重复返回了同一记忆序号',
  memory_retrieval_index_missing: 'AI 遗漏了待处理记忆序号',
  memory_retrieval_language_invalid: 'AI 返回的语言标识不符合 BCP-47 格式',
  memory_retrieval_source_language_unverifiable: '来源不可验证时 AI 未使用 und 语言标识，已拒绝结果',
  memory_retrieval_alias_language_missing: 'AI 没有返回来源语、简体中文和英文所需的检索别名',
  memory_retrieval_alias_language_invalid: 'AI 返回了目标范围以外的检索别名语言',
  memory_retrieval_alias_count_invalid: 'AI 返回的某种语言检索别名为空或数量不正确',
  memory_retrieval_alias_invalid: 'AI 返回的检索别名包含空值或控制字符',
  memory_retrieval_alias_too_long: 'AI 返回的单条检索别名超过 128 字节',
  memory_retrieval_alias_secret: 'AI 返回的检索别名疑似包含秘密，已拒绝整批结果',
  memory_retrieval_rewrite_literal_missing: '正文改写遗漏了技术字面量；原正文已保留，仅应用安全检索别名',
  memory_retrieval_rewrite_secret: '正文改写疑似包含秘密；原正文已保留，仅应用安全检索别名',
  memory_retrieval_rewrite_invalid: '正文改写为空、过长或包含非法控制字符，已拒绝整批结果',
  memory_retrieval_rewrite_missing: 'AI 未返回可验证的来源语言改写；原正文已保留，仅应用安全检索别名',
  memory_retrieval_rewrite_not_allowed: '来源不可验证，已拒绝正文改写并仅应用安全检索别名',
  memory_retrieval_prepared_invalid: '已保存的跨语言检索方案无法安全恢复',
  memory_retrieval_snapshot_changed: '记忆在回填期间发生变化，将按新修订重试',
  ...
  memory_phase2_stale_undispositioned: 'AI 没有处理与本次来源变化相关的失效记忆',
