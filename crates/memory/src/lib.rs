...
pub use model::{
    ...
    MemoryConsolidationReport, MemoryEmbeddingScheduleReport, MemoryEmbeddingStatusView,
    MemoryOrigin, MemoryPipelineResetReport, MemoryRelationView, MemoryRetrievalCoverageView,
    ...
    PipelineRegenerationAdmission, RecallContext, RecallRequest, RecallResult, RelatedNoteView,
